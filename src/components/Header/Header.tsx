...
export default function Header() {
  ...
  // Tất nhiên là trừ trường hợp logout rồi nhảy vào registerLayOut ròi nhảy vào lại
        ...
        <div className='mt-4 grid grid-cols-12 items-center gap-4'>
          ...
          <form className='col-span-9' onSubmit={onSubmitSearch}>
            <div className='flex rounded-sm bg-white p-1'>
              <input
                type='text'
                className='flex-grow border-none bg-transparent py-2 px-3 text-black outline-none'
          ...
          <div className='col-span-1 justify-self-end'>
                    ...
                    <div className='p-4'>
                      ...
                      <div className='mt-5'>
                        {purchasesInCart.slice(0, 5).map((purchase) => (
                          // Trong giỏ hàng thì hiện thị max=5 sản phẩm => slice(0,5)
                      ...
                      <div className='mt-6 flex items-center justify-between'>
                        ...
                        <Link to={path.cart} className='rounded-sm bg-orange px-4 py-2 text-white hover:opacity-60'>
                          Xem giỏ hàng
                        </Link>
                      </div>
                    </div>
            ...
            >
              <Link to='/cart' className='relative'>
                ...
                {/* purchasesInCart : có purchasesInCart thì mới render ra số lượng hàng trong giỏ hàng */}
                {purchasesInCart && (
