...
export default function ChangePassword() {
  type FormDataPassword = Pick<UserSchema, 'password' | 'new_password' | 'confirm_password'>
      ...
      if (isAxiosUnprocessableEntity<ErrorResponse<FormDataPassword>>(error)) {
        ...
        if (formError) {
          Object.keys(formError).forEach((key) => {
            setError(key as keyof FormDataPassword, {
              message: formError[key as keyof FormDataPassword],
              type: 'Server'
            })
          })
        }
